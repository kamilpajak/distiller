 ...
 */
TEST_F(DistillationStateManagerTest,
       SetStateDoesNotResetTimerForOtherStates) { // NOLINT(cppcoreguidelines-owning-memory)
 ...
 */
TEST_F(DistillationStateManagerTest,
       FullDistillationProcessStateTransitions) { // NOLINT(cppcoreguidelines-owning-memory)
  // Reset to a known state
  setMillis(0);
